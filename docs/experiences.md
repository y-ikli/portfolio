...
Cette page présente mes expériences sous l’angle des **responsabilités data**, de la **construction de pipelines** et de la **mise à disposition de données exploitables**, dans une logique orientée **Data Engineer / Analytics Engineer**.
...
- Structuration des flux et des jeux de données analytiques utilisés par des équipes internes.
...
- Développement de pipelines ETL en Python pour l’ingestion de données issues de fichiers structurés (TXT, CSV, Excel).
...
- Ingestion de sources tabulaires hétérogènes et normalisation des données.
- Conception de transformations analytiques et de pipelines paramétrables.
- Production de jeux de données exploitables par des utilisateurs métier.

---

## Projets Data appliqués

### CHU de Lille  
**Projet Data — Master 2 Data Science**  

- Projet professionnel réalisé dans le cadre du Master 2.
- Préparation, structuration et analyse de jeux de données complexes issus d’un contexte réel.
- Travaux de classification, sélection de variables et gestion de données déséquilibrées.
...
Ces expériences mettent en évidence :
...
- la capacité à documenter, fiabiliser et rendre exploitables des jeux de données,
